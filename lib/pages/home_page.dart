    ...
    activityCards = [
      {
        ...
        'time': '10 mins',
        'desc':
            'Journaling helps clear your mind and capture your thoughts. Write down one thing you’re grateful for today.',
        'button': 'Begin',
      ...
      },
      {
        ...
        'time': '5 mins',
        'desc':
            'Take a deep breath and follow a short guided meditation to reset your energy.',
        'button': 'Play',
      ...
      },
      {
        ...
        'time': 'Flexible',
        'desc':
            'Choose one small goal for today. Taking small steps builds long-term success.',
        'button': 'Set Goal',
      ...
      },
      {
        ...
        'time': '2 mins',
        'desc':
            'Pause and reflect: “Every day is a fresh start.” Carry this thought with you.',
        'button': 'Read More',
                      ...
                      children: [
                        GestureDetector(
                          onTap: () => Navigator.push(
                              context, createRoute(ProfilePage())),
                          child: CircleAvatar(
                            radius: 26,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: themeProvider.isDarkMode
                                    ? Color(0xFFB7A6DE).withOpacity(
                                        0.9) // slightly darker, faded purple
      ...
      children: [
        Row(
          ...
          children: List.generate(3, (i) {
            ...
            double imgSize =
                (i == 2 || i == 3) ? 64 : 54; // Angry & Sleepy bigger
            return GestureDetector(
              onTap: () => _onTap(i),
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  double opacity =
                      (selectedIndex == null || isSelected) ? 1.0 : 0.85;
                  return Opacity(
                    opacity: opacity,
        ...
        Row(
          ...
          children: List.generate(3, (i) {
            ...
            double imgSize = (idx == 3 || idx == 4 || idx == 5)
                ? 64
                : 54; // Sleepy, Stressed & Loved bigger
            return GestureDetector(
              onTap: () => _onTap(idx),
              child: AnimatedBuilder(
                animation: _controller,
